...
// --- HELPER: Calculate Duration (BARU) ---
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-end border-b border-slate-200 pb-5 gap-4">
                ...
                <div class="w-full md:w-auto bg-slate-200 p-1 rounded-xl flex">
                    <button 
                        @click="viewMode = 'list'"
                        :class="[
                            'flex-1 md:flex-none px-6 py-2 rounded-lg text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-2 transition-all',
                            viewMode === 'list' 
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-lg shadow-slate-100/50 overflow-hidden min-h-125">
                <div v-if="viewMode === 'list'" class="animate-fade-in">
                    ...
                    <div class="p-0 md:p-2">
                        <DataTable 
                            :value="sortedBookings" :loading="loading" paginator :rows="10"
                        ...
                        >
                            ...
                            <Column header="Requester" headerClass="text-left pl-4 md:pl-6" bodyClass="text-left pl-4 md:pl-6">
                                <template #body="{ data }">
                                    <div class="flex flex-col">
                                        <span class="font-black text-slate-700 text-sm whitespace-nowrap">
                            ...
                            <Column header="Room Name" headerClass="text-left" bodyClass="text-left">
                                <template #body="{ data }">
                                    <span class="font-bold text-indigo-600 text-xs whitespace-nowrap">
                                        {{ data.room_name || getRoomName(data.room_id) }}
                                    </span>
                                </template>
                            </Column>
